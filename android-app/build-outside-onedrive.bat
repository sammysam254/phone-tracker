...
if exist "app\build\outputs\apk\release\app-release.apk" (
    ...
    copy /Y "app\build\outputs\apk\release\app-release.apk" "%ORIGINAL_DIR%..\web-dashboard\apk\child-app-v1.2.0.apk"
    
    echo.
    echo APK copied to:
    echo - %ORIGINAL_DIR%app\build\outputs\apk\release\app-release.apk
    echo - %ORIGINAL_DIR%..\web-dashboard\apk\child-app-v1.2.0.apk
    echo.
